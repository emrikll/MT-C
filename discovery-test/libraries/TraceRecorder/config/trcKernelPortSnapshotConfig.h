 ...
 */
#define TRC_CFG_NAME_LEN_TASK			7
#define TRC_CFG_NAME_LEN_ISR			7
#define TRC_CFG_NAME_LEN_QUEUE			7
#define TRC_CFG_NAME_LEN_SEMAPHORE		7
#define TRC_CFG_NAME_LEN_MUTEX			7
#define TRC_CFG_NAME_LEN_TIMER			7
#define TRC_CFG_NAME_LEN_EVENTGROUP 	7
#define TRC_CFG_NAME_LEN_STREAMBUFFER 	7
#define TRC_CFG_NAME_LEN_MESSAGEBUFFER 	7
